...
const sampleItems = [
  ...
  { id: 8, name: "Unscented Soy Candle", brand: "Fontana Candle Co.", certifications: [], room: "bedroom" },
  { id: 9, name: "Solid Wood Coat Rack", brand: "West Elm", certifications: ["FSC"], room: "entryway" },
  { id: 10, name: "Natural Fiber Entry Mat", brand: "Ruggable", certifications: ["OEKO-TEX"], room: "entryway" },
  { id: 11, name: "Stackable Storage Bins", brand: "Open Spaces", certifications: [], room: "small-spaces" },
  { id: 12, name: "Solid Wood Desk", brand: "Medley Home", certifications: ["FSC", "GREENGUARD"], room: "office" },
  { id: 13, name: "Ergonomic Office Chair", brand: "Autonomous", certifications: ["GREENGUARD"], room: "office" },
  { id: 14, name: "Bamboo Monitor Stand", brand: "Uplift", certifications: ["FSC"], room: "office" },
  { id: 15, name: "Unscented Beeswax Candle", brand: "Big Dipper Wax Works", certifications: [], room: "office" },
  { id: 16, name: "Teak Outdoor Dining Table", brand: "West Elm", certifications: ["FSC"], room: "patio" },
